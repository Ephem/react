...
function timeAge(time) {
  // Time when writing this code to keep it deterministic
  const now = 1563737807265 / 1000;
    ...
    e(
      ...
      e(
        ...
        e(
          'tbody',
          null,
          stories.map((story, i) => e(Story, {story, rank: ++i, key: story.id}))
        )
      )
    )
  );
...
module.exports = <App stories={stories} />;
